...
<head>
    ...
    <link rel="shortcut icon" href="imagesa/lavanderia-icono.png" type="image/x-icon">
    <title>Laundry</title>
                    ...
                    <div class="row container-inputs">
                        <form class="col s12" action="ClienteServlet" method="post">
                            ...
                            <div class="button-container-home">
                                <button type="submit" class="waves-effect waves-light btn #283593 indigo darken-3"><i class="fas fa-search"></i> Consultar</button>
                                <br>
